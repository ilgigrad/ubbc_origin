...
// Retourne les inscriptions créées ou modifiées depuis une date donnée.
//
// Méthode : GET
// Auth    : header X-UBBC-TOKEN
// Params  :
//   ?since=YYYY-MM-DD ou YYYY-MM-DD HH:MM:SS  — filtre sur updated_at (défaut : tout)
...
$sql = "
    SELECT
        ...
        payment_at, shirt_size, shirt_model,
