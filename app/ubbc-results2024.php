...
if (isset($_GET['order']) && in_array($_GET['order'],array('bib','lastname','gender','category','srank','rrank','crank','faster','duration','laps','expected','current','pending','race'))){
    $order=$_GET['order'];
}
else {
    $order='srank';
...
?>
  ...
  <section class="container-fluid">
        ...
        <!--<div class="panel-sub">    -->
            <h1 class="fl-txt-gray fl-txt-25 text-uppercase pt-2 text-center">RESULTATS UBBC 9 - 2024</h1>
            ...
            <table class="mx-auto table table-stripped table-hover table-bordered table-sm vw-100 table-responsive-lg">
                ...
                <tr>
                    <th class="thin"><a href='ubbc-results2024.php?race=<?php echo $race ?>&order=srank&asc=<?php echo $asc ?>'>Rang</a></th>
                    ...
                    <th class="medium"><a href='ubbc-results2024.php?race=<?php echo $race ?>&order=duration&asc=<?php echo $asc ?>'>Chrono</a></th>
                    <th class="medium"><a  href='ubbc-results2024.php?race=<?php echo $race ?>&order=race&asc=<?php echo $asc ?>'>Course</a></th>
