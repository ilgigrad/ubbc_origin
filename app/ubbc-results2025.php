...
$sqlcount = 'SELECT count(bib) as nb FROM results_2025 '.$raceFilter.' ORDER BY bib ASC ';
...
?>
  ...
  <section class="container-fluid">
        ...
        <!--<div class="panel-sub">    -->
            <h1 class="fl-txt-gray fl-txt-25 text-uppercase pt-2 text-center">RESULTATS UBBC 10 - 2025</h1>
            ...
            <table class="mx-auto table table-stripped table-hover table-bordered table-sm vw-100 table-responsive-lg">
                ...
                <tr>
                    ...
                    <th class="medium"><a  href='ubbc-results2025.php?race=<?php echo $race ?>&order=raceid&asc=<?php echo $asc ?>'>Course</a></th>
                    <th class="thin"><a href='ubbc-results2025.php?race=<?php echo $race ?>&order=rrank&asc=<?php echo $asc ?>'>Rang Course</a></th>
                    <th class="medium"><a href='ubbc-results2025.php?race=<?php echo $race ?>&order=chrono&asc=<?php echo $asc ?>'>Chrono</a></th>
                    <th class="medium"><a href='ubbc-results2025.php?race=<?php echo $race ?>&order=faster&asc=<?php echo $asc ?>'>Record</a></th>
                    <th class="thin"><a href='ubbc-results2025.php?race=<?php echo $race ?>&order=bib&asc=<?php echo $asc ?>'>BIB</a></th>
                    <th class="large"><a href='ubbc-results2025.php?race=<?php echo $race ?>&order=lastname&asc=<?php echo $asc ?>'>Nom</a></th>
                    <th class="large"><a href='ubbc-results2025.php?race=<?php echo $race ?>&order=firstname&asc=<?php echo $asc ?>'>Pr&eacute;nom</a></th>
                    <th class="thin"><a href='ubbc-results2025.php?race=<?php echo $race ?>&order=gender&asc=<?php echo $asc ?>'>Genre</a></th>
                    <th class="thin"><a href='ubbc-results2025.php?race=<?php echo $race ?>&order=category&asc=<?php echo $asc ?>'>Cat&eacute;gorie</a></th>
                    <th class="thin"><a href='ubbc-results2025.php?race=<?php echo $race ?>&order=crank&asc=<?php echo $asc ?>'>Rang Genre</a></th>
                    <th class="thin"><a href='ubbc-results2025.php?race=<?php echo $race ?>&order=laps&asc=<?php echo $asc ?>'>Tours</a></th>
                    <th class="medium"><a href='ubbc-results2025.php?race=<?php echo $race ?>&order=duration&asc=<?php echo $asc ?>'>Durée</a></th>
                    <th class="medium"><a href='ubbc-results2025.php?race=<?php echo $race ?>&order=average&asc=<?php echo $asc ?>'>Moyene</a></th>
                    <th class="thin"><a href='ubbc-results2025.php?race=<?php echo $race ?>&order=srank&asc=<?php echo $asc ?>'>UBBC index</a></th>
...
<?php
    ...
    if ($cpage>1){
         echo "<li class='page-item'><a class='page-link fl-txt-prune' href='ubbc-results2025.php?race=$race&page=".($cpage-1)."&order=$order&asc=$asc'>précédent</a></li>";
    }
    else {
    ...
    for($i=1;$i<=$nbpage;$i++) {
        ...
        elseif(abs($i-$cpage)<4) {
            echo "<li class='page-item'><a class='page-link fl-txt-prune' href='ubbc-results2025.php?race=$race&page=$i&order=$order&asc=$asc'>$i</a></li>";
        }
    }
    if ($cpage<$nbpage){
         echo "<li class='page-item'><a class='page-link fl-txt-prune' href='ubbc-results2025.php?race=$race&page=".($cpage+1)."&order=$order&asc=$asc'>suivant</a></li>";
    }
    else {
