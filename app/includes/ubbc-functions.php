...
//=====Création du header de l'e-mail.
    $header = 'From: organisation ubbc <contact@ubbc.fr>'.$passage_ligne;
    $header.= 'Reply-to: organisation ubbc <contact@ubbc.fr>'.$passage_ligne;
...
//=====Envoi de l'e-mail.
    mailjet_api($mail,$subject,$message,$header);
//==========
}
