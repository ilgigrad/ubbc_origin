...
?>
  ...
  <section class="container-fluid">
        ...
        <!--<div class="panel-sub">    -->
            <h1 class="fl-txt-gray fl-txt-25 text-uppercase pt-2 text-center">RESULTS</h1>
...
$sqlquery = <<< EOT
  ...
  FROM results l
  INNER JOIN
    (SELECT l.bib, @rank:=@rank+1 AS rank FROM results l,(SELECT @rank:=0) r $raceFilter ORDER BY laps DESC, chrono ASC) r
    ON r.bib=l.bib
  INNER JOIN
