...
<section class="container-fluid justify-content-center">
    <h1 class="text-center text-uppercase fl-txt-peach pt-2"> EDIT OR CREATE USER</h1>
    <form class="px-2 col-md-4 mx-auto my-5" method="post" action="/ubbc-validemail.php">
      <input type="hidden" name="direct" value="<?php echo $direct; ?>">
        ...
        <button type="submit" class="btn btn-lg fl-bg-prune fl-bg-hov-sadsea fl-txt-white m-auto d-block">process</button>
    </form>
</section>
